<template>
  <div class="vslider-bar-component vslider-bar-horizontal"
    ref="wrap"
    :id="id"
    :style="calculateHeight"
    @click="wrapClick">
    <div class="vslider-bar"
      ref="elem" :style="{height: `${lineHeight}px`}">
      <template>
        <div class="vslider-bar-always vslider-bar-tooltip-container"
          ref="tooltip"        
          :style="{'width': `${iconWidth}px`}"
          @mousedown="moveStart"
          @touchstart="moveStart">
          <span class="vslider-bar-tooltip-top vslider-bar-tooltip-wrap"
            v-if="showTooltip">
            <slot name="tooltip">
              <span class="vslider-bar-tooltip"
                :style="tooltipStyles">
                {{ val }}
              </span>
            </slot>
      ...
      <div class="vslider-bar-process"
        ref="process"
        :style="processStyle"/>
    </div>
    <div class="vslider-bar-range"
      v-if="range">
      <div class="vslider-bar-separate"
        v-for="(r, index) in range"
        :key="index"
        :style="dataLabelStyles">
        <span class="vslider-bar-separate-text"
          v-if="!r.isHide">
          {{ r.label }}
        </span>
      </div>
